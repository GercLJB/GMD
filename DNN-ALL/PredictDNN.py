...
#
INDIM, HIDDIM1, HIDDIM2, HIDDIM3, HIDDIM4, OUTDIM = 43, 20, 10, 5, 3, 1
...
for T in TIME_LIST[RUN_TIME]:
    ...
    CMAQ_MIN, CMAQ_MAX, CMAQ_MEAN, CMAQ_STD = SCALE_df.loc['f_PM2_5'][2], SCALE_df.loc['f_PM2_5'][3], SCALE_df.loc['f_PM2_5'][1], SCALE_df.loc['f_PM2_5'][0]
    ...
    Result_df = pd.DataFrame([], columns=['Date', 'Target', 'AI', 'CMAQ'])
    ...
    Result_df['CMAQ'] = (Validation_df['f_PM2_5'] * (CMAQ_MAX - CMAQ_MIN)) + CMAQ_MIN
    Result_df['CMAQ'] = (Result_df['CMAQ'] * CMAQ_STD) + CMAQ_MEAN
